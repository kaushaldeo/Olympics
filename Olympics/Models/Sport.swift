...
class SportParser : KDParseOperation {
    ...
    override func parser(parser: NSXMLParser, didStartElement elementName: String, namespaceURI: String?, qualifiedName qName: String?, attributes attributeDict: [String : String]) {
        ...
        if self.startParsing && elementName == "sport" {
    ...
    override func processedData(objects: [NSManagedObject]) {
        ...
        let fetchRequest = NSFetchRequest(entityName: objects.first!.nameOfClass)
        
        let entityDescription = NSEntityDescription.entityForName(objects.first!.nameOfClass, inManagedObjectContext:self.context)
        ...
        for item in objects {
            fetchRequest.predicate = NSPredicate(format: "identifier = %@", item.valueForKey("identifier") as! String)
